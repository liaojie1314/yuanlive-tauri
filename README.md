...
| 🎙️   | 语音输入(包括转文字) | ![完成](https://img.shields.io/badge/✅-完成-008080?style=flat&labelColor=e6f7f7&color=008080)        |
...
| 🚨   | 埋点上传(posthog)    | ![完成](https://img.shields.io/badge/✅-完成-008080?style=flat&labelColor=e6f7f7&color=008080)        |
...
| 功能 | 描述       | 状态                                                                                                  |
| ---- | ---------- | ----------------------------------------------------------------------------------------------------- |
| 🖼️   | 漫画阅读器 | ![进行中](https://img.shields.io/badge/50%25-进行中-f0ad4e?style=flat&labelColor=faf3e6&color=f0ad4e) |
| 🎨   | drawio     | ![进行中](https://img.shields.io/badge/50%25-进行中-f0ad4e?style=flat&labelColor=faf3e6&color=f0ad4e) |
...
| 🌐   | web 适配            | ![进行中](https://img.shields.io/badge/0%25-进行中-f0ad4e?style=flat&labelColor=faf3e6&color=f0ad4e)  |
...
| 🤖   | AI 助手  | ![进行中](https://img.shields.io/badge/40%25-进行中-f0ad4e?style=flat&labelColor=faf3e6&color=f0ad4e) |
...
获取TELEMETRY_API_KEY环境变量

1. 前往[posthog](https://posthog.com/)完成注册
2. 点击右上角Dashboard进入管理页面
3. 点击左上角Default project下拉选择Project settings, 即可在右侧查看Project token, 即为TELEMETRY_API_KEY
...
| [vant](https://vant.pro/vant/#/zh-CN) | Vue3 app 组件库 |
