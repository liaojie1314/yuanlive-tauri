...
impl Url {
    pub fn get_url(&self) -> (http::Method, &str) {
        match self {
            ...
            Url::GetChildCategory => (http::Method::GET, "live/category/children"),
            // 关注相关
            ...
            Url::UnpinConversation => (
                http::Method::GET,
                "ai/history/unpinSession/{conversationId}",
            ),
    ...
    fn from_str(s: &str) -> Result<Self, anyhow::Error> {
        match s {
            ...
            "getChildCategory" => Ok(Url::GetChildCategory),
            // 关注相关
